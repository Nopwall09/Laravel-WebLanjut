    ...
    <table class="table table-bordered table-striped" id="tabel-produk">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $data->stock }}</td>
                <td>
                    <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalEditProduk{{ $data->id }}">Ubah</button>
                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modalHapusProduk{{ $data->id }}">Hapus</button>
                </td>
            </tr>
